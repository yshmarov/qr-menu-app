...
MenuItem.create(name: 'Polaris Gazowana', price: 199, menu_category: 'drinks', image_url: 'https://i.imgur.com/7BGt24V.png')
MenuItem.create(name: 'Polaris Niegazowana', price: 159, menu_category: 'drinks', image_url: 'https://i.imgur.com/CkaVyAQ.png')
MenuItem.create(name: 'Sezamki Classic', price: 399, menu_category: 'food', image_url: 'https://i.imgur.com/r1pZQ1P.png')
MenuItem.create(name: 'Rafaello', price: 99, menu_category: 'food', image_url: 'https://i.imgur.com/XwLtkud.png')
MenuItem.create(name: 'Mini Bounty', price: 59, menu_category: 'food', image_url: 'https://i.imgur.com/JasXScr.png')
MenuItem.create(name: 'Mini Snickers', price: 59, menu_category: 'food', image_url: 'https://i.imgur.com/ORYBJqE.png')
