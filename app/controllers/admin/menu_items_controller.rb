class Admin::MenuItemsController < SecuredController
  ...
  def create
    ...
    if @menu_item.save
      redirect_to %i[admin menu_items], notice: "Menu item created."
    else
  ...
  def update
    if @menu_item.update(menu_item_params)
      redirect_to %i[admin menu_items], notice: "Menu item updated."
    else
  ...
  def destroy
    @menu_item.destroy
    redirect_to %i[admin menu_items], notice: "Menu item destroyed."
  end
